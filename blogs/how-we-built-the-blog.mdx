...
social:
  twitter:
    ...
    - "4/ Content lives at the repo root (outside the Astro project) and is pulled in by a glob loader. Type-safe frontmatter via Zod. Blogs and app code don't tangle."
